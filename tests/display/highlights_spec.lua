...
describe('highlights', function()
  ...
  describe('set()', function()
    it('places extmark for single-line RIGHT-side thread', function()
      ...
      assert.equals(4, mark[2]) -- 0-indexed row (line 5 = row 4)
      assert.is_table(mark[4])
      assert.equals('NitCommentHighlight', mark[4].hl_group)
      assert.equals(5, mark[4].end_row) -- exclusive end
      assert.equals(0, mark[4].end_col)
    end)
    ...
    it('places extmark for multi-line thread using start_line', function()
      ...
      assert.equals(1, #extmarks)
      local mark = extmarks[1]
      assert.equals(2, mark[2]) -- start_line 3 = row 2
      assert.equals(5, mark[4].end_row) -- line 5 = exclusive row 5 (covers lines 3-5)
      assert.equals(0, mark[4].end_col)
    end)
    ...
    it('handles single-line thread when start_line is nil', function()
      ...
      assert.equals(1, #extmarks)
      local mark = extmarks[1]
      assert.equals(6, mark[2]) -- line 7 = row 6
      assert.equals(7, mark[4].end_row) -- exclusive end at row 7
    end)
