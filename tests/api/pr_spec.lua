describe('nit.api.pr', function()
  ...
  describe('fetch_pr', function()
    ...
    it('normalizes PR-level comments array', function()
      ...
      assert.are.equal(2, result.data.comments[1].reactions['+1'])
      assert.are.equal(1, result.data.comments[1].reactions['heart'])
    ...
    it('handles reaction with missing users field', function()
      ...
      assert.is_true(result.ok)
      assert.are.equal(0, result.data.comments[1].reactions['+1'])
    end)
