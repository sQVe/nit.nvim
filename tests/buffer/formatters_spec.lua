describe('nit.buffer.formatters', function()
  ...
  describe('get_reaction_icon', function()
    it('returns +1 for +1', function()
      assert.equals('+1', formatters.get_reaction_icon('+1'))
    end)
    ...
    it('returns emoji icons for uppercase reaction keys', function()
      assert.equals('👍', formatters.get_reaction_icon('THUMBS_UP'))
      assert.equals('👎', formatters.get_reaction_icon('THUMBS_DOWN'))
      assert.equals('😄', formatters.get_reaction_icon('LAUGH'))
      assert.equals('🎉', formatters.get_reaction_icon('HOORAY'))
      assert.equals('😕', formatters.get_reaction_icon('CONFUSED'))
      assert.equals('❤️', formatters.get_reaction_icon('HEART'))
      assert.equals('🚀', formatters.get_reaction_icon('ROCKET'))
      assert.equals('👀', formatters.get_reaction_icon('EYES'))
    end)
